...
namespace GraphQLAuth.Api.Migrations
{
    ...
    [Migration("20250606125021_AddClientNavigationProperties")]
    partial class AddClientNavigationProperties
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GraphQLAuth.Api.Models.Status", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Health = 0,
                            LastUpdated = new DateTimeOffset(new DateTime(2025, 6, 5, 20, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("GraphQLAuth.Api.Models.Asset", b =>
                {
                    b.HasOne("GraphQLAuth.Api.Models.Client", "Client")
                        .WithMany()
