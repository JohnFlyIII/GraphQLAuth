...
namespace GraphQLAuth.Api.Migrations
{
    ...
    [Migration("20250605182922_AddBlogAssetManyToMany")]
    partial class AddBlogAssetManyToMany
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlogAsset", b =>
                {
                    b.HasOne("GraphQLAuth.Api.Models.Asset", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("FK_BlogAsset_Asset_AssetId");
                    ...
                    b.HasOne("GraphQLAuth.Api.Models.Blog", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_BlogAsset_Blog_BlogId");
                });
